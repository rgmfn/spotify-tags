...
export type ListItemSlotsAndSlotProps = CreateSlotsAndSlotProps<ListItemSlot, {
...
export interface ListItemTypeMap<P = {}, D extends React.ElementType = 'li'> {
    props: P & ListItemSlotsAndSlotProps & {
        /**
...
export type ListItemProps<D extends React.ElementType = ListItemTypeMap['defaultComponent'], P = {
