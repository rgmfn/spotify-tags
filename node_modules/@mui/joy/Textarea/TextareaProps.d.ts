...
export type TextareaSlotsAndSlotProps = CreateSlotsAndSlotProps<TextareaSlot, {
...
export interface TextareaTypeMap<P = {}, D extends React.ElementType = 'div'> {
    props: P & TextareaSlotsAndSlotProps & Pick<React.TextareaHTMLAttributes<HTMLTextAreaElement>, 'autoComplete' | 'autoFocus' | 'onClick' | 'onChange' | 'onKeyDown' | 'onKeyUp' | 'onFocus' | 'onBlur' | 'defaultValue' | 'value' | 'placeholder' | 'readOnly' | 'required' | 'name' | 'id' | 'disabled'> & {
        /**
...
export type TextareaProps<D extends React.ElementType = TextareaTypeMap['defaultComponent'], P = {
