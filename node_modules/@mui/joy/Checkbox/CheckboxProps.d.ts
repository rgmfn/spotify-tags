...
export type CheckboxSlotsAndSlotProps = CreateSlotsAndSlotProps<CheckboxSlot, {
...
export interface CheckboxTypeMap<P = {}, D extends React.ElementType = 'span'> {
    props: P & UseSwitchParameters & CheckboxSlotsAndSlotProps & {
        /**
...
export type CheckboxProps<D extends React.ElementType = CheckboxTypeMap['defaultComponent'], P = {
