...
export type AlertSlotsAndSlotProps = CreateSlotsAndSlotProps<AlertSlot, {
...
export interface AlertTypeMap<P = {}, D extends React.ElementType = 'div'> {
    props: P & AlertSlotsAndSlotProps & {
        /**
...
export type AlertProps<D extends React.ElementType = AlertTypeMap['defaultComponent'], P = {
