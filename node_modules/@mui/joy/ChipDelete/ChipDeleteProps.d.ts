...
export interface ChipDeleteTypeMap<P = {}, D extends React.ElementType = 'button'> {
    props: P & {
         ...
         */
        onDelete?: React.EventHandler<React.MouseEvent<HTMLButtonElement> | React.KeyboardEvent<HTMLButtonElement>>;
        /**
...
export type ChipDeleteProps<D extends React.ElementType = ChipDeleteTypeMap['defaultComponent'], P = {
