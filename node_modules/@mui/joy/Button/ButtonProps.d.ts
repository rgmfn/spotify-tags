...
export type ButtonSlotsAndSlotProps = CreateSlotsAndSlotProps<ButtonSlot, {
...
export interface ButtonTypeMap<P = {}, D extends React.ElementType = 'button'> {
    props: P & ButtonSlotsAndSlotProps & {
        /**
...
export type ButtonProps<D extends React.ElementType = ButtonTypeMap['defaultComponent'], P = {
...
export type ExtendButton<M extends OverridableTypeMap> = ((props: OverrideProps<ExtendButtonTypeMap<M>, 'a'>) => JSX.Element) & OverridableComponent<ExtendButtonTypeMap<M>>;
