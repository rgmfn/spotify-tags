...
export type TooltipSlotsAndSlotProps = CreateSlotsAndSlotProps<TooltipSlot, {
    root: SlotProps<'div', {
...
export type TooltipProps<D extends React.ElementType = TooltipTypeMap['defaultComponent'], P = {
    component?: React.ElementType;
