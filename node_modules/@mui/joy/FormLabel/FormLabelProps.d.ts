...
export type FormLabelSlotsAndSlotProps = CreateSlotsAndSlotProps<FormLabelSlot, {
...
export interface FormLabelTypeMap<P = {}, D extends React.ElementType = 'label'> {
    props: P & FormLabelSlotsAndSlotProps & {
        /**
...
export type FormLabelProps<D extends React.ElementType = FormLabelTypeMap['defaultComponent'], P = {
