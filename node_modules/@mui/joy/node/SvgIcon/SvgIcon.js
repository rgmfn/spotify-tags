...
process.env.NODE_ENV !== "production" ? SvgIcon.propTypes /* remove-proptypes */ = {
   ...
   * @default 'inherit'
   */
  color: _propTypes.default /* @typescript-to-proptypes-ignore */.oneOfType([_propTypes.default.oneOf(['danger', 'info', 'inherit', 'neutral', 'primary', 'success', 'warning']), _propTypes.default.string]),
  /**
