...
const useUtilityClasses = ownerState => {
  ...
  return (0, _composeClasses.default)(slots, _autocompleteClasses.getAutocompleteUtilityClass, {});
};
...
const AutocompleteClearIndicator = (0, _styled.default)(_IconButton.StyledIconButton, {
  ...
  ownerState
}) => (0, _extends2.default)({}, !ownerState.hasPopupIcon && {
...
const AutocompleteLimitTag = (0, _styled.default)('span', {
  name: 'JoyAutocomplete',
  slot: 'NoOptions',
  overridesResolver: (props, styles) => styles.noOptions
})({
...
const Autocomplete = /*#__PURE__*/React.forwardRef(function Autocomplete(inProps, ref) {
  ...
  const {
    ...
    inputValue,
    groupedOptions
  } = (0, _AutocompleteUnstyled.useAutocomplete)((0, _extends2.default)({}, props, {
  ...
  if (anchorEl) {
    ...
    popup = /*#__PURE__*/(0, _jsxRuntime.jsx)(_ListProvider.default, {
      nested: true,
