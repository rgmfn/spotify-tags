...
const _excluded = ["children", "className", "color", "slotProps", "onClick", "disabled", "size", "variant", "startDecorator", "endDecorator"];
...
const ChipRoot = (0, _styled.default)('div', {
  ...
  return [(0, _extends2.default)({
    ...
    [`&.${_chipClasses.default.disabled}`]: (_theme$variants4 = theme.variants[`${ownerState.variant}Disabled`]) == null ? void 0 : _theme$variants4[ownerState.color]
  }] : [{
...
const ChipAction = (0, _styled.default)('button', {
  ...
  return [{
    ...
    [`&.${_chipClasses.default.disabled}`]: (_theme$variants10 = theme.variants[`${ownerState.variant}Disabled`]) == null ? void 0 : _theme$variants10[ownerState.color]
  }];
});
