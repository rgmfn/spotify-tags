...
(function (ClassNames) {
  ...
  ClassNames["emojiHasVariatios"] = "epr-emoji-has-variations";
...
var categoriesOrdered = [exports.Categories.SUGGESTED, exports.Categories.SMILEYS_PEOPLE, exports.Categories.ANIMALS_NATURE, exports.Categories.FOOD_DRINK, exports.Categories.TRAVEL_PLACES, exports.Categories.ACTIVITIES, exports.Categories.OBJECTS, exports.Categories.SYMBOLS, exports.Categories.FLAGS];
var SuggestedRecent = {
  name: 'Recently Used',
...
function useThemeConfig() {
  ...
  if (theme === exports.Theme.AUTO) {
    return isSystemDarkTheme() ? exports.Theme.DARK : exports.Theme.LIGHT;
  }
...
function useGetEmojiUrlConfig() {
  var _usePickerConfig16 = usePickerConfig(),
      getEmojiUrl = _usePickerConfig16.getEmojiUrl;
...
function useEmojiVariationPickerState() {
  var _React$useContext8 = React.useContext(PickerContext),
...
function useUpdateSuggested() {
  var _React$useContext11 = React.useContext(PickerContext),
...
function queryScrollBody(root) {
  return root ? root.matches(asSelectors(ClassNames.scrollBody)) ? root : root.querySelector(asSelectors(ClassNames.scrollBody)) : null;
}
...
function ClickableEmoji(_ref) {
  ...
  return React.createElement(Button, {
    className: clsx(ClassNames.emoji, (_clsx = {}, _clsx[ClassNames.hidden] = hidden, _clsx[ClassNames.hiddenOnSearch] = hiddenOnSearch, _clsx[ClassNames.visible] = !hidden && !hiddenOnSearch, _clsx[ClassNames.emojiHasVariatios] = hasVariations && showVariations, _clsx)),
...
function EmojiList() {
  ...
  return React.createElement("ul", {
    ...
    if (category === exports.Categories.SUGGESTED) {
      return React.createElement(Suggested, {
        key: category,
        categoryConfig: categoryConfig
      });
    }

    return React.createElement(RenderCategory, {
      key: category,
      index: index,
      category: category,
      categoryConfig: categoryConfig
...
function RenderCategory(_ref) {
  ...
  var getEmojiUrl = useGetEmojiUrlConfig(); // Small trick to defer the rendering of all emoji categories until the first category is visible
...
function EmojiVariationPicker() {
  ...
  var visible = emoji && button && emojiHasVariations(emoji) && button.classList.contains(ClassNames.emojiHasVariatios);
  React.useEffect(function () {
    if (!visible) {
      return;
    }
...
function Body() {
  ...
  return React.createElement("div", {
    ...
    ref: BodyRef
  }, React.createElement(EmojiVariationPicker, null), React.createElement(EmojiList, null));
}
...
function PreviewBody() {
  ...
  function PreviewContent() {
    ...
    return React.createElement(React.Fragment, null, React.createElement("div", null, show ? React.createElement(ViewOnlyEmoji, {
      ...
      size: 45,
      getEmojiUrl: getEmojiUrl
    }) : null), show ? React.createElement("div", {
      className: "epr-preview-emoji-label"
    }, emojiName(emoji)) : React.createElement("div", {
      className: "epr-preview-emoji-label"
    }, defaultText));
  }
}
...
function PickerRootElement(_ref2) {
  ...
  return React.createElement("aside", {
    className: clsx(ClassNames.emojiPicker, 'epr-main', (_clsx = {}, _clsx[ClassNames.searchActive] = searchModeActive, _clsx['epr-dark-theme'] = theme === exports.Theme.DARK, _clsx)),
    ref: PickerMainRef,
    style: style
  }, children);
}
...
function EmojiPicker(props) {
  return React.createElement(ElementRefContextProvider, null, React.createElement(PickerConfigProvider, Object.assign({}, props), React.createElement(PickerMain, null, React.createElement(Header, null), React.createElement(Body, null), React.createElement(Preview, null))));
}
...
function EmojiPicker$1(props) {
  return React.createElement(ErrorBoundary, null, React.createElement(EmojiPicker, Object.assign({}, props)));
}
